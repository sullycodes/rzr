...
class EstimatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estimate" do
    assert_difference('Estimate.count') do
      post estimates_url, params: { estimate: { address: @estimate.address, price: @estimate.price, site: @estimate.site } }
    end
  ...
  test "should update estimate" do
    patch estimate_url(@estimate), params: { estimate: { address: @estimate.address, price: @estimate.price, site: @estimate.site } }
